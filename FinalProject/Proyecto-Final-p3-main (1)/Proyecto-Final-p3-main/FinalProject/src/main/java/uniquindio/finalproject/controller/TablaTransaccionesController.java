...
public class TablaTransaccionesController {
    ...
    void ClickBack(ActionEvent event) {
        ...
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Tabla Transacciones Controlador", 3, "clickVolver", ("C:\\td\\Persistencia\\Log\\log.txt"));
    }
