...
public class AdicionCuentasController {
    ...
    void ClickAgregarCuenta(ActionEvent event) {
        guardarCuenta();
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre(), 1, "ClickAgregarCuenta", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    void ClickActualizar(ActionEvent event) {
        ...
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Adicion Cuentas", 1, "clickActualizar", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    void ClickEliminar(ActionEvent event) {
        ...
        if (cuentaSeleccionada != null) {
            ...
            limpiarCampos();
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Adicion Cuentas", 1, "clickEliminar", ("C:\\td\\Persistencia\\Log\\log.txt"));
        } else {
    ...
    void ClickLimpiar(ActionEvent event) {
        limpiarCampos();
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Adicion Cuentas", 1, "clickLimpiar", ("C:\\td\\Persistencia\\Log\\log.txt"));
