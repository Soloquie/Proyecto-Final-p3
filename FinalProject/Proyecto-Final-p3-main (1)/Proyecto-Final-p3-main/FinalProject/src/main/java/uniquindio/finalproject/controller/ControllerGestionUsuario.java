...
public class ControllerGestionUsuario implements Initializable {
    ...
    void ClickGuardar(ActionEvent event) {
        try {
            ...
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario", 1, "clickGuardar", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    void ClickEliminar(ActionEvent event) {
        try {
            ...
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario", 1, "clickEliminar", ("C:\\td\\Persistencia\\Log\\log.txt"));
            limpiarCampos();
            ...
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario. Error no usuario seleccionado", 2, "clickGuardar Error", ("C:\\td\\Persistencia\\Log\\log.txt"));
            System.err.println("Error al eliminar: " + e.getMessage());
        } catch (Exception e) {
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario. Error al eliminar usuario", 2, "clickGuardar Error", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    void ClickLimpiar(ActionEvent event) {
        ...
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario", 1, "clickLimpiar", ("C:\\td\\Persistencia\\Log\\log.txt"));
    }
    ...
    public void ClickActualizar(ActionEvent actionEvent) {
        try {
            ...
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario", 1, "clickActualizar", ("C:\\td\\Persistencia\\Log\\log.txt"));
            ...
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario. Actualizacion de usuario fallida", 2, "clickActuaizar Error", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    public void clickMostrarEstadisticas(ActionEvent actionEvent) {
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario", 1, "clickMostrarEstadisticas", ("C:\\td\\Persistencia\\Log\\log.txt"));

    }

    @FXML
    public void ClickPresupuestos(ActionEvent actionEvent) {
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario", 1, "clickPresupuestos", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    public void ClickAgregarCuentas(ActionEvent actionEvent) {
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario", 1, "clickAgregarCuenta", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    public void clickCerrarSesion(ActionEvent event) {
        ...
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Gestion Usario", 1, "clickCerrarSesion", ("C:\\td\\Persistencia\\Log\\log.txt"));
    }
