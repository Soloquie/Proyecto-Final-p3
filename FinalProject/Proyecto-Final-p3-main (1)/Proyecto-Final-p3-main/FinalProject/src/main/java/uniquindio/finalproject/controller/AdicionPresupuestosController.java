...
public class AdicionPresupuestosController {
    ...
    void ClickAgregarPresupuesto(ActionEvent event) {
        añadirPresupuesto();
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Adicion Presupuestos", 1, "clickAgregarPresupuesto", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    void ClickBack(ActionEvent event) {
        ...
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Adicion Presupuestos", 1, "clickVolver", ("C:\\td\\Persistencia\\Log\\log.txt"));
    }
