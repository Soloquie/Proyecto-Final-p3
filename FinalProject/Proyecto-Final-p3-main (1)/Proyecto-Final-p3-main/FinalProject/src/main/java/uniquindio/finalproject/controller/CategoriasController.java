...
public class CategoriasController {
    ...
    void ClickGuardar(ActionEvent event) {
        ...
        try {
            ...
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Categoria Usuario", 1, "clickGuardar", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    void ClickActualizar(ActionEvent event) {
        ...
        if (categoriaSeleccionada != null) {
            ...
            actualizarTabla();
            limpiarCampos();
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Controlador Categoria Usuario", 1, "clickActualizar", ("C:\\td\\Persistencia\\Log\\log.txt"));
