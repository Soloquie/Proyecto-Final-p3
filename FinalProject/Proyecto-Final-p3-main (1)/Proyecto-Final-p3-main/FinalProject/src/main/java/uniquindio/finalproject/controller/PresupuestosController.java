...
public class PresupuestosController implements Initializable {
    ...
    void ClickActualizar(ActionEvent event) {
        ...
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Presupuesto Controlador", 1, "clickActualizar", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    void ClickBack(ActionEvent event) {
        ...
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Presupuesto Controlador", 1, "clickVolver", ("C:\\td\\Persistencia\\Log\\log.txt"));
    }
    ...
    void ClickEliminar(ActionEvent event) {
        ...
        if (presupuestoSeleccionado != null) {
            ...
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Presupuesto Controlador", 1, "clickEliminar", ("C:\\td\\Persistencia\\Log\\log.txt"));
            limpiarCampos();
        } else {
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Presupuesto Controlador. Error, presupuesto no seleccionado", 2, "clickActualizar", ("C:\\td\\Persistencia\\Log\\log.txt"));
            mostrarMensaje("Error", "Error", "No se ha seleccionado presupuesto para eliminar", Alert.AlertType.ERROR);
    ...
    void ClickGuardar(ActionEvent event) {
        try {
            ...
            persistencia.guardarPresupuesto(nuevoPresupuesto);
            ...
            limpiarCampos();
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Presupuesto Controlador", 1, "clickGuardar", ("C:\\td\\Persistencia\\Log\\log.txt"));
            ...
            ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Presupuesto Controlador Error", 3, "clickActualizar", ("C:\\td\\Persistencia\\Log\\log.txt"));
    ...
    void ClickLimpiar(ActionEvent event) {
        ArchivoUtil.guardarRegistroLog("Usuario: "+SesionGlobal.usuarioActual.getNombre()+" Presupuesto Controlador", 1, "clickLimpiar", ("C:\\td\\Persistencia\\Log\\log.txt"));
        limpiarCampos();
    }
