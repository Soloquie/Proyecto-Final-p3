...
public class GestionTransaccionController {
    ...
    void ClickEnviarDinero(ActionEvent event) {
        ...
        Transaccion nuevaTransaccion = new Transaccion(SesionGlobal.usuarioActual, idTransaccion,fecha, tipoTransaccion, monto, descripcion, cuentaOrigen, cuentaDestino, categoria);
