...
public class BilleteraUtils {
    ...
    public static BilleteraAplicacion inicializarDatos() {
        ...
        Cuenta cuenta1 = new Cuenta("1", "BancoA", "123456", TipoCuenta.AHORRO, usuario1, 200.0);
        Cuenta cuenta2 = new Cuenta("2", "BancoB", "654321", TipoCuenta.CORRIENTE, usuario2, 200.0);
