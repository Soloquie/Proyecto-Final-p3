...
public class PresupuestosViewController {
    ...
    void ClickGuardar(ActionEvent event) {
        ...
        if (nuevoPresupuesto != null) {
            ...
            cargarPresupuestos();
            limpiarCampos();
            persistencia.guardarRegistroLog("ClickGuardar", 1, "Se ha guardado un presupuesto por: "+usuarioActual.nombre());
    ...
    void ClickActualizar(ActionEvent event) {
        ...
        if (presupuestoSeleccionado != null) {
            ...
            cargarPresupuestos();
            limpiarCampos();
            persistencia.guardarRegistroLog("ClickActualizar", 1, "Se ha actualizado un presupuesto por: "+usuarioActual.nombre());
        ...
        persistencia.guardarRegistroLog("ClickActualizar", 3, "No se ha podido actualizar un presupuesto : "+usuarioActual.nombre());
    }
    ...
    void ClickEliminar(ActionEvent event) {
        ...
        if (presupuestoSeleccionado != null) {
            ...
            cargarPresupuestos();
            persistencia.guardarRegistroLog("ClickEliminar", 1, "Se ha eliminado un presupuesto por: "+usuarioActual.nombre());
            limpiarCampos();
        }
        persistencia.guardarRegistroLog("ClickEliminar", 3, "No se ha podido eliminar un presupuesto : "+usuarioActual.nombre());
    }
    ...
    public void ClickLimpiar(ActionEvent event){
        persistencia.guardarRegistroLog("ClickLimpiar", 1, "Se han limpiado las casillas : "+usuarioActual.nombre());
        limpiarCampos();
    }

    @FXML
    public void ClickBack(ActionEvent event) {
        persistencia.guardarRegistroLog("ClickBack", 1, "Se han vuelto a la escena anterior  : "+usuarioActual.nombre());
